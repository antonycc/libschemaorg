...
buildscript {
    ...
    dependencies {
        ...
        //classpath group: "co.uk.polycode", name: 'owl-to-java',
...
tasks {
    ...
    val regenerate by registering(uk.co.polycode.owltojava.RegenerateOntologyTask::class) {
        ...
        val srcMain: String = Paths.get("${projectDir}/src/main").toAbsolutePath().toFile().absolutePath
        val sourceFileName = "schemaorg.owl"
        lang = "en"
        src = Paths.get("${srcMain}/resources/${sourceFileName}").toAbsolutePath().toFile().absolutePath
        //dest = "INFO"
        dest = Paths.get("${buildDir}/generated-src").toAbsolutePath().toFile().absolutePath
